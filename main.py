    ...
    float: none;
      ...
      <body>
        <form {{url_for('chatbotsystem')}} method="POST">
          <h1>Enquiry Chabot</h1>
          <div class="icon">
    	 <i class="fas fa-user-circle"></i>
          </div>
          <div class="formcontainer">
          <div class="container">
           <label for="ufname"><strong>Hi!! Hello and welcome to the college enquiry site.</strong></label></br></br>
    	  <label for="ufname"><strong>Select your questions from the list below.</strong></label></br>
...
def endchat():
    ...
    [Creator Details]<br>
    <label for="ufname"><strong>Ramya Karanam, karanara@mail.uc.edu</strong></label></br></br>
    """
